            ...
            <Wizard.Header>
              {({ currentPage, totalPages }) => (
                <div>
                  ...
                  <p className="message">
                    {gettext('Welcome ALL Testing edX! Before you get started, please take a few minutes to fill-in the additional information below to help us understand a bit more about your background. You can always edit this information later in Account Settings.')}
                  </p>
                  <br />
