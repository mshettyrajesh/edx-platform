...
class CourseInfoTitleTestCase(LoginEnrollmentTestCase, ModuleStoreTestCase):
    ...
    @ddt.data(
        ...
        ({},
         "Welcome ALL Testing HogwartsX's Potions101!", "Introduction to Potions"),
